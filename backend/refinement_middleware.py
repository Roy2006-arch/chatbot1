...
class ResponseRefinementMiddleware:
    def __init__(self):
        ...
        self.robotic_phrases = [
            ...
            r'(?:Thank you|Thanks) for (?:your |reaching out|contacting |the )?(?:question|message|query|inquiry)[!.]?\s*',
            r'(?:I hope|Hope) (?:this|that) (?:helps|answers your question|clarifies things)[!.]?\s*',
            r'(?:Please )?(?:feel free|don\'t hesitate) to (?:ask|reach out|let me know)[^.]*[!.]?\s*',
            r'(?:It\'s|It is) a (?:pleasure|great) to (?:assist|help)[^.]*[!.]?\s*',
